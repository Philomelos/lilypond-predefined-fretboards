...
#(define a-shape-with-fingering (make-fretboard-table))
% diagrams containing fingering indications
#(define a-shape-alt-one-with-fingering (make-fretboard-table))
% diagrams containing chord degrees
#(define a-shape-with-chord-degrees (make-fretboard-table))
% diagrams containing pitch names
#(define a-shape-with-pitch-names (make-fretboard-table))
% diagrams containing movable do solfege names (do-based)
#(define a-shape-with-movable-do (make-fretboard-table))
% diagrams containing movable fa solfege names (fa-based)
#(define a-shape-with-movable-fa (make-fretboard-table))
% diagrams containing movable so solfege names (so-based)
#(define a-shape-with-movable-so (make-fretboard-table))

aShape = {
  \set predefinedDiagramTable = #a-shape-with-fingering
  %\includeStyleSheet
}

aShapeAltOne = {
  \set predefinedDiagramTable = #a-shape-alt-one-with-fingering
}
...
aShapeChordDegrees = {
  \set predefinedDiagramTable = #a-shape-with-chord-degrees
}

aShapePitchNames = {
  \set predefinedDiagramTable = #a-shape-with-pitch-names
}

aShapeMovableDo = {
  \set predefinedDiagramTable = #a-shape-with-movable-do
}

aShapeMovableFa = {
  \set predefinedDiagramTable = #a-shape-with-movable-fa
}

aShapeMovableSo = {
  \set predefinedDiagramTable = #a-shape-with-movable-so
}
...
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { c:1.8 }
                        #guitar-tuning
                        #(offset-fret 2 (
                          chord-shape 'bes,:1.8
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { c,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 3 (
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { cis,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 4 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { des,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 4 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { d,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 5 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { dis,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 6 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { es,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 6 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { e,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 7 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { f,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 8 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { fis,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 9 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { ges,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 9 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { g,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 10 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { gis,,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #"x;5-4;3-2;1-1;o;x;"

% ******* as dim7; 2nd inv.; 4 notes; 3rd on top
\storePredefinedDiagram #a-shape-with-fingering \chordmode { as,,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #"x;5-4;3-2;1-1;o;x;"

% ******* a dim7; 2nd inv.; 4 notes; 3rd on top
\storePredefinedDiagram #a-shape-with-fingering \chordmode { a,,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning)

% ******* ais dim7; 2nd inv.; 4 notes; 3rd on top
\storePredefinedDiagram #a-shape-with-fingering \chordmode { ais,,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 1 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { bes,,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 1 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering \chordmode { b,,:5-.7-.8.10-^1.3 }
                        #guitar-tuning
                        #(offset-fret 2 (
                          chord-shape 'a,:5-.7-.8.10-^1.3
                          guitar-tuning))
...
% ****** 4 notes
% ******* add a-shape maj7+5 defs (root pos., 3rd on top, drop 2, 4 n.)
\addChordShape #'bes,:1.5+.7+.10
               #guitar-tuning
               #"x;1-1;4-4;2-2;3-3;x;"

% ******* store predef. a-shape maj7+5 dgr. (root pos., 3rd on top, drop 2, 4 n.)
% ******** c maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { c,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 2 (
...
% ******** cis maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { cis,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 3 (
...
% ******** des maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { des,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 3 (
...
% ******** d maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { d,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 4 (
...
% ******** dis maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { dis,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 5 (
...
% ******** es maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { es,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 5 (
...
% ******** e maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { e,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 6 (
...
% ******** f maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { f,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 7 (
...
% ******** fis maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { fis,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 8 (
...
% ******** ges maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { ges,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 8 (
...
% ******** g maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { g,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 9 (
...
% ******** gis maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { gis,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 10 (
...
% ******** as maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { as,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 10 (
...
% ******** a maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { a,,:1.5+.7+.10 }
                        #guitar-tuning
                        #"x;o;3-3;1-1;2-2;x;"

% ******** ais maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { ais,,:1.5+.7+.10 }
                        #guitar-tuning
                        #(chord-shape 'bes,:1.5+.7+.10
...
% ******** bes maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { bes,,:1.5+.7+.10 }
                        #guitar-tuning
                        #(chord-shape 'bes,:1.5+.7+.10
...
% ******** b maj7+5; root pos.; 3rd on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { b,,:1.5+.7+.10 }
                        #guitar-tuning
                        #(offset-fret 1 (
...
% ****** 4 notes
% ******* add a-shape maj7+5 defs (root pos., 5th on top, drop 3, 4 n.)
\addChordShape #'bes,:1.7+.10.12+
               #guitar-tuning
               #"x;1-1;x;2-2;3-4;2-3;"

% ******* store predef. a-shape maj7+5 dgr. (root pos., 5th on top, drop 3, 4 n.)
% ******** c maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { c,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 2 (
...
% ******** cis maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { cis,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 3 (
...
% ******** des maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { des,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 3 (
...
% ******** d maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { d,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 4 (
...
% ******** dis maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { dis,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 5 (
...
% ******** es maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { es,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 5 (
...
% ******** e maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { e,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 6 (
...
% ******** f maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { f,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 7 (
...
% ******** fis maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { fis,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 8 (
...
% ******** ges maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { ges,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 8 (
...
% ******** g maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { g,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 9 (
...
% ******** gis maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { gis,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 10 (
...
% ******** as maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { as,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 10 (
...
% ******** a maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { a,,:1.7+.10.12+ }
                        #guitar-tuning
                        #"x;o;x;1-1;2-3;1-2;"

% ******** ais maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { ais,,:1.7+.10.12+ }
                        #guitar-tuning
                        #(chord-shape 'bes,:1.7+.10.12+
...
% ******** bes maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { bes,,:1.7+.10.12+ }
                        #guitar-tuning
                        #(chord-shape 'bes,:1.7+.10.12+
...
% ******** b maj7+5; root pos.; 5th on top; drop 3; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { b,,:1.7+.10.12+ }
                        #guitar-tuning
                        #(offset-fret 1 (
...
% ***** drop 2 (open position)
% ****** 4 notes
% ******* add a-shape maj7+5 defs (1st inv., 5th on top, drop 2, 4 n.)
\addChordShape #'as,:3.7+.8.12+^1
               #guitar-tuning
               #"x;3-2;5-3;1-1;5-4;x;" %difficult

% ******* store predef. a-shape maj7+5 dgrms. (1st inv., 5th on top, drop 2, 4 n.)
...
% ***** Drop 2 (open position)
% ****** 4 notes
% ******* add a-shape maj7+5 defs (2nd inv., 7th on top, drop 2, 4 n.)
\addChordShape #'as,:5+.8.10.14+^1.3
               #guitar-tuning
               #"x;x;2-2;1-1-(;1-1-);3-4;"

% ******* store predef. a-shape maj7+5 dgrms. (2nd inv., 7th on top, drop 2, 4 n.)
...
% ***** drop 3 (open position)
% ****** 4 notes
% ******* add a-shape maj7+5 defs (3rd inv., 3rd on top, drop 3, 4 n.)
\addChordShape #'as,,:7+.12+.15.17^1.3.5+
               #guitar-tuning
               #"3-3;x;2-2;1-1-(;1-1-);x;"

% ******* store predef. a-shape maj7+5 dgr. (3rd inv., 3rd on top, drop 3, 4 n.)
...
% ***** drop 2 (open position)
% ****** 4 notes
% ******* add a-shape maj7+5 defs (3rd inv., 5th on top, drop 2, 4 n.)
\addChordShape #'a,,:7+.15.17.19+^1.3.5+
               #guitar-tuning
               #"4-4;x;x;2-2;2-3;1-1;" %difficult

% ******* store predef. a-shape maj7+5 dgr. (3rd inv., 5th on top, drop 2, 4 n.)
% ******** c maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { c,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 3 (
...
% ******** cis maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { cis,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 4 (
...
% ******** des maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { des,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 4 (
...
% ******** d maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { d,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 5 (
...
% ******** dis maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { dis,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 6 (
...
% ******** es maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { es,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 6 (
...
% ******** e maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { e,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 7 (
...
% ******** f maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { f,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 8 (
...
% ******** fis maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { fis,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 9 (
...
% ******** ges maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { ges,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 9 (
...
% ******** g maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { g,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 10 (
...
% ******** gis maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { gis,,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #"3-4;x;x;1-1;1-2;o;"

% ******** as maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { as,,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #"3-4;x;x;1-1;1-2;o;"

% ******** a maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { a,,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(chord-shape 'a,,:7+.15.17.19+^1.3.5+
...
% ******** ais maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { ais,,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 1 (
...
% ******** bes maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { bes,,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 1 (
...
% ******** b maj7+5; 3rd inv.; 5th on top; drop 2; 4 n.
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { b,,,:7+.15.17.19+^1.3.5+ }
                        #guitar-tuning
                        #(offset-fret 2 (
...
% ****** 4 notes
% ******* add a-shape maj7-5 defs (root pos., 3rd on top, o.p., 4 n.)
\addChordShape #'bes,:1.5-.7+.10
               #guitar-tuning
               #"x;1-1;2-2;2-3;3-4;x;"

% ******* store predef. a-shape maj7-5 dgr. (root pos., 3rd on top, o.p., 4 n.)
...
% ****** 4 notes
% ******* add a-shape maj7-5 defs (root pos., 5th on top, o.p., 4 n.)
\addChordShape #'b,:1.7+.10.12-
               #guitar-tuning
               #"x;2-2;x;3-3;4-4;1-1;"

% ******* store predef. a-shape maj7-5 dgr. (root pos., 5th on top, o.p., 4 n.)
...
% ***** open position (Drop 2)
% ****** 4 notes
% ******* add a-shape maj7-5 defs (2nd inv., 7th on top, o.p., 4 n.)
\addChordShape #'a,:5-.8.10.14+^1.3
               #guitar-tuning
               #"x;x;1-1;2-2;2-3;4-4;"

% ******* store predef. a-shape maj7-5 dgrms. (2nd inv., 7th on top, o.p., 4 n.)
...
% ***** open position (Drop 3)
% ****** 4 notes
% ******* add a-shape maj7-5 defs (3rd inv., 3rd on top, o.p., 4 n.)
\addChordShape #'a,,:7+.12-.15.17^1.3.5-
               #guitar-tuning
               #"4-4;x;1-1;2-2;2-3;x;" %difficult

% ******* store predef. a-shape maj7-5 dgrms. (3rd inv., 3rd on top, o.p., 4 n.)
...
% ****** 4 notes
% ******* add a-shape maj7-5 defs (3rd inv., 5th on top, o.p., 4 n.)
\addChordShape #'b,,:7+.15.17.19-^1.3.5-
               #guitar-tuning
               #"6-4;x;x;4-2;4-3;1-1;" %hardly possible

% ******* store predef. a-shape maj7-5 dgr. (3rd inv., 5th on top, o.p., 4 n.)
% ******** c maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { c,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 1 (
...
% ******** cis maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { cis,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 2 (
...
% ******** des maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { des,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 2 (
...
% ******** d maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { d,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 3 (
...
% ******** dis maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { dis,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 4 (
...
% ******** es maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { es,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 4 (
...
% ******** e maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { e,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 5 (
...
% ******** f maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { f,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 6 (
...
% ******** fis maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { fis,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 7 (
...
% ******** ges maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { ges,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 7 (
...
% ******** g maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { g,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 8 (
...
% ******** gis maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { gis,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 9 (
...
% ******** as maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { as,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 9 (
...
% ******** a maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { a,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(offset-fret 10 (
...
% ******** ais maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { ais,,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #"5-4;x;x;3-1;3-2;o;"

% ******** bes maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { bes,,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #"5-4;x;x;3-1;3-2;o;"

% ******** b maj7-5; 3rd inv.; 5th on top; o.p.; 4 notes
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { b,,,:7+.15.17.19-^1.3.5- }
                        #guitar-tuning
                        #(chord-shape 'b,,:7+.15.17.19-^1.3.5-
...
% * modern "church modes"
% ** major/ionian
% *** pattern 1 (leavitt type 1)
% **** with fingering
% ***** complete box pattern (17 pitches)
% ****** add amaj7-shape p1 ionian definitions (17 pitches)
\addChordShape #'c,:4.5.6.7+.8.9.10.20_fingering
               #guitar-tuning
               #'((place-fret 1 5 4)
                  (place-fret 1 3 2)
                  (place-fret 1 1 1)
                  ...
                  (place-fret 4 2 1)
                  (place-fret 5 5 4 )
                  (place-fret 5 3 2 blue)
                  (place-fret 5 2 1)
                  (place-fret 6 5 4)
                  (place-fret 6 3 2)
                  (place-fret 6 1 1))

% **** store predefined a-shape ionian mode (17 pitches)
% ***** a ionian mode, complete box pattern (17 pitches)
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { a,,:4.5.6.7+.8.9.10.20 }
                        #guitar-tuning
                        #(offset-fret 9 (
                          chord-shape 'c,:4.5.6.7+.8.9.10.20_fingering
                          guitar-tuning))

% ***** ais ionian mode, complete box pattern (17 pitches)
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { ais,,:4.5.6.7+.8.9.10.20 }
                        #guitar-tuning
                        #(offset-fret 10 (
                          chord-shape 'c,:4.5.6.7+.8.9.10.20_fingering
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { bes,,:4.5.6.7+.8.9.10.20 }
                        #guitar-tuning
                        #(offset-fret 10 (
                          chord-shape 'c,:4.5.6.7+.8.9.10.20_fingering
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { cis,,:4.5.6.7+.8.9.10.20 }
                        #guitar-tuning
                        #(offset-fret 1 (
                          chord-shape 'c,:4.5.6.7+.8.9.10.20_fingering
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { des,,:4.5.6.7+.8.9.10.20 }
                        #guitar-tuning
                        #(offset-fret 1 (
                          chord-shape 'c,:4.5.6.7+.8.9.10.20_fingering
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { dis,,:4.5.6.7+.8.9.10.20 }
                        #guitar-tuning
                        #(offset-fret 3 (
                          chord-shape 'c,:4.5.6.7+.8.9.10.20_fingering
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { es,,:4.5.6.7+.8.9.10.20 }
                        #guitar-tuning
                        #(offset-fret 3 (
                          chord-shape 'c,:4.5.6.7+.8.9.10.20_fingering
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { fis,,:4.5.6.7+.8.9.10.20 }
                        #guitar-tuning
                        #(offset-fret 6 (
                          chord-shape 'c,:4.5.6.7+.8.9.10.20_fingering
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { ges,,:4.5.6.7+.8.9.10.20 }
                        #guitar-tuning
                        #(offset-fret 6 (
                          chord-shape 'c,:4.5.6.7+.8.9.10.20_fingering
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { gis,,:4.5.6.7+.8.9.10.20 }
                        #guitar-tuning
                        #(offset-fret 8 (
                          chord-shape 'c,:4.5.6.7+.8.9.10.20_fingering
                          guitar-tuning))
...
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { as,,:4.5.6.7+.8.9.10.20 }
                        #guitar-tuning
                        #(offset-fret 8 (
                          chord-shape 'c,:4.5.6.7+.8.9.10.20_fingering
                          guitar-tuning))
...
% ***** complete box pattern (17 pitches)
% ****** add amaj7-shape p1 ionian definitions (17 pitches)
\addChordShape #'c,:4.5.6.7+.8.9.10.20_movable-do
               #guitar-tuning
               #'((place-fret 1 5 "La'")
                  (place-fret 1 3 "So'")
                  (place-fret 1 1 "Fa'")
...
% **** store predefined a-shape ionian mode (17 pitches)
% ***** a ionian mode, complete box pattern (17 pitches)
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { a,,:4.5.6.7+.8.9.10.20 }
                        #guitar-tuning
                        #(offset-fret 9 (
                          chord-shape 'c,:4.5.6.7+.8.9.10.20_movable-do
                          guitar-tuning))
...
% * modern "church modes"
% ** major/ionian
% *** pattern 2 (leavitt type 1B)
% **** with fingering
% ***** complete box pattern (17 pitches)
% ****** add amaj7-shape p2 ionian definitions (17 pitches)
\addChordShape #'bes,,:5.6.7+.8.9.10.11.21_fingering
               #guitar-tuning
               #'((place-fret 1 5 4)
                  (place-fret 1 3 3)
                  (place-fret 1 1 1)
                  ...
                  (place-fret 5 5 4)
                  (place-fret 5 3 3)
                  (place-fret 5 1 1 blue)
                  (place-fret 6 5 4)
                  (place-fret 6 3 3)
                  (place-fret 6 1 1))

% **** store predefined a-shape ionian mode (17 pitches)
% ***** a ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { a,,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #'((place-fret 1 4 4)
                           (place-fret 1 2 3)
                           (place-fret 1 0 0)
                           ...
                           (place-fret 5 4 4 )
                           (place-fret 5 2 3)
                           (place-fret 5 0 0 blue)
                           (place-fret 6 4 4)
                           (place-fret 6 2 3)
                           (place-fret 6 0 0))

% ***** ais ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { ais,,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning)

% ***** bes ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { bes,,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning)

% ***** b ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                 \chordmode { b,,,:5.6.7+.8.9.10.11.21 }
                  #guitar-tuning
                  #(offset-fret 1 (
                    chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                    guitar-tuning))
...
% ***** c ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { c,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 2 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))

% ***** cis ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { cis,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 3 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))

% ***** des ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { des,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 3 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))

% ***** d ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { d,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 4 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))

% ***** dis ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { dis,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 5 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))

% ***** es ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { es,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 5 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))

% ***** e ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { e,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 6 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))

% ***** f ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { f,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 7 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))

% ***** fis ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { fis,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 8 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))

% ***** ges ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { ges,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 8 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))

% ***** g ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { g,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 9 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))

% ***** gis ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { gis,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 10 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))

% ***** as ionian, pattern 2, fingering, complete box pattern
\storePredefinedDiagram #a-shape-with-fingering
                        \chordmode { as,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 10 (
                          chord-shape 'bes,,:5.6.7+.8.9.10.11.21_fingering
                          guitar-tuning))
...
% * modern "church modes"
% ** major/ionian
% *** pattern 3 (leavitt type 1B)
% **** with fingering
% ***** complete box pattern (17 pitches)
% ****** add amaj7-shape p3 ionian definitions (17 pitches)
\addChordShape #'bes,,:5.6.7+.8.9.10.11.21_alt1-fingering
               #guitar-tuning
               #'((place-fret 1 5 4)
                  (place-fret 1 3 2)
                  (place-fret 1 1 1)
...
% **** store predefined a-shape ionian mode (17 pitches)
% ***** a ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { a,,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #'((place-fret 1 4 4)
                           (place-fret 1 2 2)
...
% ***** ais ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { ais,,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(chord-shape 'bes,,:5.6.7+.8.9.10.11.21_alt1-fingering
                          guitar-tuning)

% ***** bes ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { bes,,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(chord-shape 'bes,,:5.6.7+.8.9.10.11.21_alt1-fingering
...
% ***** b ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                 \chordmode { b,,,:5.6.7+.8.9.10.11.21 }
                  #guitar-tuning
                  #(offset-fret 1 (
...
% ***** c ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { c,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 2 (
...
% ***** cis ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { cis,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 3 (
...
% ***** des ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { des,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 3 (
...
% ***** d ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { d,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 4 (
...
% ***** dis ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { dis,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 5 (
...
% ***** es ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { es,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 5 (
...
% ***** e ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { e,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 6 (
...
% ***** f ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { f,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 7 (
...
% ***** fis ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { fis,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 8 (
...
% ***** ges ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { ges,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 8 (
...
% ***** g ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { g,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 9 (
...
% ***** gis ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { gis,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 10 (
...
% ***** as ionian, pattern 3, fingering, complete box pattern
\storePredefinedDiagram #a-shape-alt-one-with-fingering
                        \chordmode { as,,:5.6.7+.8.9.10.11.21 }
                        #guitar-tuning
                        #(offset-fret 10 (
...
% * modern "church modes"
% ** nat. minor/aeolian
% *** am7-s0 (leavitt type 3)
% **** with movable do
% ***** complete box pattern (17 pitches)
% ****** add am7-s0-shape aeolian definitions (17 pitches)
\addChordShape #'bes,,:5.6-.7.8.9.10-.11.19_movable-do
               #guitar-tuning
               #'((place-fret 1 4 "So'")
                  (place-fret 1 2 "Fa'")
                  (place-fret 1 1 "Mi'")
                  ...
                  (place-fret 5 4 "Do")
                  (place-fret 5 3 "Ti,")
                  (place-fret 5 1 "La," red)
                  (place-fret 6 4 "So,")
                  (place-fret 6 2 "Fa,")
                  (place-fret 6 1 "Mi,"))

% ****** store predefined am7-s0-shape aeolian mode (17 pitches)
% ******* a aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { a,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #'((place-fret 1 3 "So'")
                        (place-fret 1 1 "Fa'")
                        (place-fret 1 0 "Mi'")
                        ...
                        (place-fret 5 3 "Do")
                        (place-fret 5 2 "Ti,")
                        (place-fret 5 0 "La," red)
                        (place-fret 6 3 "So,")
                        (place-fret 6 1 "Fa,")
                        (place-fret 6 0 "Mi,"))

% ******* ais aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { ais,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #guitar-tuning
                        #(chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning)

% ******* bes aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { bes,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #guitar-tuning
                        #(chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning)

% ******* b aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { b,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 1 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))

% ******* c aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                 \chordmode { c,,:5.6-.7.8.9.10-.11.19 }
                 #guitar-tuning
                 #(offset-fret 2 (
                 chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                 guitar-tuning))

% ******* cis aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { cis,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 3 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))

% ******* des aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { des,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 3 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))

% ******* d aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { d,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 4 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))

% ******* dis aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { dis,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 5 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))

% ******* es aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { es,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 5 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))

% ******* e aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { e,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 6 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))

% ******* f aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { f,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 7 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))

% ******* fis aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { fis,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 8 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))

% ******* ges aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { ges,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 8 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))

% ******* g aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { g,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 9 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))

% ******* gis aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { gis,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 10 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))

% ******* as aeolian, am7-s0-shape, movable do, complete box pattern
\storePredefinedDiagram #a-shape-with-movable-do
                        \chordmode { as,,:5.6-.7.8.9.10-.11.19 }
                        #guitar-tuning
                        #(offset-fret 10 (
                          chord-shape 'bes,,:5.6-.7.8.9.10-.11.19_movable-do
                          guitar-tuning))
